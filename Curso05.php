<?php 
	...
	//Arrays o Vectores
	//arrays predefinidos.
	//En PHP un array puede contener datos de diferentes tipos (int, string, boolean, etc)
	$array = array("elemento1", 2, "Elemento 3", true);

	//Al igual que en otros mensajes el primer indice de un array es 0
	echo "Valor de elemento 1 de array normal: " . $array[0] . "<br>";

	//Arrays asociativos, se escribe la clave y el valor del elemento.
	$arrayAsociativo = array("clave1" => "Valor del elemento 1", "clave2" => "valor del elemento2");

	//Para imprimir se utiliza el valor de la clave
